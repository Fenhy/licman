...
{  
    ...
    {  
        ...
        {  
            ...
            LicenseContent content= licenseManager.install(new File(licdir+File.separator+licName));  
            System.out.println("安装证书成功!");
            Date currentTime = new Date();
            SimpleDateFormat formate=new SimpleDateFormat("yyyy-MM-dd");  
            System.out.println(formate.format(content.getNotAfter()));
        }  
        catch (Exception e)  
        {  
    ...
    {  
        ...
        {  
            ...
            System.out.println("证书卸载成功!");  
        }  
        catch (Exception e)  
        {  
            System.out.println("证书卸载失败!");  
            e.printStackTrace();  
            System.exit(0);  
        }  
